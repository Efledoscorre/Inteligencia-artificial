...
Projeto realizado em Python utilizando Inteligencia Artificial para detecção automatica de diferentes posturas corporais utilizando visão computacional
...
### Você precisará ter as seguintes ferramentas instaladas:
  ...
  Python 3.11.0: Versão mínima necessária para compilar e rodar o projeto.
 ...
 ### Dependencias necessárias para rodar a aplicação:
...
* git clone https://github.com/Efledoscorre/Inteligencia-artificial
...
* O programa será compilado e executado, abrirá sua webcam e começará as avaliações 
...
<img src ="https://contrib.rocks/image?repo=Efledoscorre/Inteligencia-artificial">
